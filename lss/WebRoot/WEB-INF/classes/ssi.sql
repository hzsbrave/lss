...
insert into sys_param(sys_param_field,sys_param_value,sys_param_type) 
values('shId','select s.sh_id as sys_param_value,s.sh_name as sys_param_text from store_house s','1');
...
/*==============================================================*/
/* Table: return_order_deatil      退货明细表
编号		rod_id：
商品		goods_id，//备用
 goods_name           varchar(20),
   goods_type           varchar(10),
...
/*==
  ...
  stock_price          decimal(12,2),    加权价 ,加权价简单可理解为平均价， 分为一次平均加权和移动平均加权。
计算如下：一次平均加权为月底一次计算库存的平均采购成本：
...
*/
/*==============================================================*/
drop table if exists sup_goods_ref;
create table sup_goods_ref
(
   goods_Id             varchar(36) not null,
	sup_id                 int
);
...
insert into sup_goods_ref(goods_id,sup_id) values(1,"2");
insert into sup_goods_ref(goods_id,sup_id) values(2,"2");
insert into sup_goods_ref(goods_id,sup_id) values(3,"1");
