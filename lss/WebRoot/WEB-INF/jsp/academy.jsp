...
<html lang="zh-CN">
  ...
  <body>
                    ...
                    <li>
                     ...
                     <li class="active">
                        ...
                        <ul class="sec-menu" style="display:block;">
                        	<li><a href="${proPath }/academy/list.action" style="color:#FF6C60;"><i></i><span>学院信息</span></a></li>
        	...
        	<section class="wrapper">
            	...
            	<div class="container">
                    <div id="toolbar" class="btn-group">
                        <a href="${proPath }/academy/add.action" class="btn btn-default" id="addStu">
    ...
    <!--模态对话框-->
    <div class="modal fade" id="academyModal" tabindex="-1">
