                    ...
                    <li>
                     ...
                     <li class="active">
                        ...
                        <ul class="sec-menu" style="display:block;">
                            ...
                            <li><a href="${proPath }/major/add.action" style="color:#FF6C60;"><i></i><span>专业添加</span></a></li>
                        </ul>
                    </li>
                     <li>
                    	<a href="javascript:void(0);">
        	...
        	<section class="wrapper">
            	<form class="form-horizontal" role="form">
                   <div class="form-group">
                      <label class="col-sm-2 control-label" for="major">专业名称：</label>
                      <div class="col-sm-5">
                         <input class="form-control" id="majorName" type="text" name="majorName">
                      </div>
                   ...
                   <div class="form-group">
                      <label class="col-sm-2 control-label" for="time">学制：</label>
                      <div class="col-sm-5">
                         <input class="form-control" id="system" type="text" name="system">
                      </div>
                      <div class="col-sm-3 alert alert-danger"></div>
                   </div>
                   <div class="form-group">
                      <div class="col-sm-5 col-sm-offset-2">
                         <span class="btn btn-primary" id="majorSubmit">提交</span>
                      </div>
                      <div class="col-sm-3 alert alert-danger"></div>
                   </div>
                </form>
...
<script src="<%=basePath %>common/js/majorsubmit.js"></script>
