            	...
            	<ul class="sidebar-menu">
                   ...
                   <li class="active">
                        ...
                        <ul class="sec-menu" style="display:block;">
                        	<li><a href="${proPath }/course/list.action" style="color:#FF6C60;"><i></i><span>基本课程设置</span></a></li>
            	...
            	<!-- 
            	 ...
            	 -->
                    <div id="toolbar" class="btn-group">
                        <a href="${proPath }/course/add.action" class="btn btn-default" id="addStu">
...
<!--模态对话框-->
    ...
    <script src="<%=basePath %>common/js/courseconfig.js"></script>
    <script>
	  $(function(){
