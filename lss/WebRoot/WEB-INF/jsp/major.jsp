                    ...
                    <li>
                     ...
                     <li class="active">
                        ...
                        <ul class="sec-menu" style="display:block;">
                        	<li><a href="${proPath }/major/list.action" style="color:#FF6C60;"><i></i><span>专业信息</span></a></li>
            	...
            	<!-- 
            	 ...
            	 -->
                    <div id="toolbar" class="btn-group">
                        <a href="${proPath }/major/add.action" class="btn btn-default" id="addStu">
...
<!--模态对话框-->
    ...
    <script src="<%=basePath %>common/js/majorconfig.js"></script>
    <script>
	  $(function(){
