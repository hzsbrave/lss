    ...
    <script type="text/javascript">
        $(document).ready(function() {
          $(".titleClose").on("click",function(){
           ...
           var $toggle = 0;
           var $val = localStorage.getItem("toggle")?localStorage.getItem("toggle"):0;
              if($val == 0){
                $(".titleToggle").children('span').attr("class","glyphicon glyphicon-chevron-up");
                $(".body-nest").show();
              }else if($val == 1){
                $(".titleToggle").children('span').attr("class","glyphicon glyphicon-chevron-down");
                $(".body-nest").hide();
              }
              $toggle = $val;
