            	...
            	<ul class="sidebar-menu">
                   ...
                   <%--  <li class="active">
                        ...
                        <ul class="sec-menu" style="display:block;">
                        	<li><a href="${proPath }/user/list.action" style="color:#FF6C60;"><i></i><span>用户信息</span></a></li>
        	...
        	<section class="wrapper">
            	<div class="container">
                    ...
                    <div id="toolbar" class="btn-group">
                        <a href="${proPath }/user/add.action" class="btn btn-default" id="addStu">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary" id="comfirm">OK</button>
			</div>
		</div><!-- /.modal-content -->
	</div><!-- /.modal-dialog -->
</div><!-- /.modal -->
<!--模态对话框-->
    ...
    <script src="<%=basePath %>common/js/userconfig.js"></script>
