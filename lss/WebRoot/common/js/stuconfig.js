	 ...
	 var operateEvents = {
         ...
         /*
                ...
                */
                ...
                $.get($('#hidden').val()+"/student/add2.action",{ flag :  "1" },function(data){
                	var appendOption = "";
                	var classList = data;
                	for(var j=0;j<classList.length;j++){
                		appendOption += '<option value='+classList[j].id+'>'+classList[j].className+'</option>';
    				}
	...
	$("#table").bootstrapTable({
           ...
           url:$('#hidden').val()+"/student/get.action",//数据源/graduationProject/data/data1.json
	...
	$refresh.click(function(){
         $table.bootstrapTable('refresh', {url: $('#hidden').val()+'/student/get.action'});
	});
