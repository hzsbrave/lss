	...
	$("#table").bootstrapTable({
           ...
           url:$('#hidden').val()+"/score/getByTeacher.action",//数据源
		   ...
		   clickToSelect: true,//当单击列时正确选择复选框或radiobox。
		   toolbar:"#tool",   
		   detailView:"true",
		   ...
		   onEditableSave: function (field, row, oldValue, $el) {
			   ...
			   $.ajax({
                   type: "post",
                   url: $('#hidden').val()+"/score/changeScore.action",
                   data: {id:row.id,score:row.score},
...
$(function () {
	...
	$refresh.click(function(){
         $table.bootstrapTable('refresh', {url: $('#hidden').val()+'/score/getByTeacher.action'});
	});
