	...
	$("#table").bootstrapTable({
           ...
           url:$('#hidden').val()+"/user/get.action",//数据源
...
$(function () {
	...
	$refresh.click(function(){
         $table.bootstrapTable('refresh', {url: $('#hidden').val()+'/user/get.action'});
	});
    ...
    $('#comfirm').click(function () {
    	 ...
    	 if($('#comfirm').hasClass("btn-info")){
    		 ...
    		 $.ajax({
 	        	url:"http://www.localhost:4414/lss/user/update.action",
 	        	type:"post",
	        ...
	        $.ajax({
	        	url:"http://www.localhost:4414/lss/user/deleteList.action",
	        	type:"post",
	      		traditional:true,
	        	data:{stuIds:ids},
	        	dataType:"json",
